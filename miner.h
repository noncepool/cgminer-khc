...
static inline void swap320(void *dest_p, const void *src_p)
{
    uint32_t *dest = dest_p;
    const uint32_t *src = src_p;
...
static inline void swab320(void *dest_p, const void *src_p)
{
    uint32_t *dest = dest_p;
    const uint32_t *src = src_p;
...
static inline void flip40(void *dest_p, const void *src_p)
{
    uint32_t *dest = dest_p;
    const uint32_t *src = src_p;
    int i;
...
static inline void flip120(void *dest_p, const void *src_p)
{
    uint32_t *dest = dest_p;
    const uint32_t *src = src_p;
    int i;
...
#endif
#ifdef USE_KRYPTOHASH
    unsigned char kryptohash_data[KRYPTOHASH_INBUFFER_SZ];
	cl_ulong target;
#endif
} dev_blk_ctx;
#else
...
struct pool {
	...
	cglock_t gbt_lock;
#ifdef USE_KRYPTOHASH
    unsigned char previousblockhash[40];
    unsigned char gbt_target[40];
#else
...
struct work {
#ifdef USE_KRYPTOHASH
    unsigned char   kryptohash[40];
    unsigned char	device_target[40];
    unsigned char	ktarget[40];
#endif
